    ...
    def run_checks_compute(self, compute=None, solver=None, solution=None, figure=None,
        ...
        * (<phoebe.frontend.bundle.RunChecksReport>) object containing all
        ...
        for compute in computes:
            ...
            if compute_kind in ['phoebe'] and self.get_value(qualifier='boosting_method', compute=compute, boosting_method=kwargs.get('boosting_method', None), **_skip_filter_checks) not in ['none', 'simple']:
                report.add_item(self,
                                "support for calculated beaming/boosting has been removed from PHOEBE 2.2.  Set boosting_method to 'none' or 'simple'.",
